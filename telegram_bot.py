...
# Остальные обработчики (handle_edit_image, handle_edit_prompt, handle_avatar_image, handle_avatar_audio, handle_animate_video, handle_animate_image) 
# остаются без изменений из telegram_bot (9).py, но для краткости они включены в финальный код ниже.
# Здесь я приведу их кратко, но в итоговом файле они должны быть полными.
...
# ----- Обработчики Robokassa и платежей -----
